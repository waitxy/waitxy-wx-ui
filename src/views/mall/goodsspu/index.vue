    ...
    <avue-crud ref="crud"
      ...
      <template slot="menuLeft">
        <el-button type="success"
                   ...
                   v-if="checkPermi(['mall:goodsspu:edit'])">批量上架
        </el-button>
        <el-button type="warning"
                   @click="batchShelf('0')"
                   size="small"
                   icon="el-icon-document"
                   v-if="checkPermi(['mall:goodsspu:edit'])">批量下架
        </el-button>
      </template>
...
import {addObj, delObj, getObj, getPage, putObj, putObjShelf} from '@/api/mall/goodsspu'
