            ...
            <div class="avue-comment__body" :style="item.type == '2' ? 'background: #6BED72;' : ''">
              ...
              <div v-if="item.repType == 'location'">
                <el-link type="primary" target="_blank"
                         :href="'https://map.qq.com/?type=marker&isopeninfowin=1&markertype=1&pointx='+item.repLocationY+'&pointy='+item.repLocationX+'&name='+item.repContent+'&ref=waitxy'">
                  <img
...
<script>
import {addObj, getPage, putObj} from '@/api/wxmp/wxmsg'
